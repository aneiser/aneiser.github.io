...
<template>
    ...
    <section class="bg--red-dark">
        <v-container>
            <h3 class="text-h4 section__title">Professional experience</h3>
            <div class="section">
                <v-row class="section__logos">
                    <v-col cols="12" class="d-flex justify-center align-center">
                        <div>
                            <svg role="img" class="icon-ubisoft-logo" xmlns="http://www.w3.org/2000/svg" version="1.1" aria-labelledby="Ubisoft logo" viewBox="0 0 99.2 31.6">
                                <title>Ubisoft</title>
                        ...
                        <div>
                            <img class="paris8-logo" src="../../img/logos/paris8-logo.png" alt="Université Paris 8 Vincennes-Saint-Denis logo">
                        </div>
                        <div>
                            <img class="smartcontact-logo" src="../../img/logos/smartcontact-logo.png" alt="SmartContact a Digital Virgo tool logo">
                        </div>
                        <div>
                            <img class="upm-logo" src="../../img/logos/upm-bar-logo.png" alt="Universidad Politécnica de Madrid logo">
                        </div>
                    </v-col>
                </v-row>
                <v-row>
